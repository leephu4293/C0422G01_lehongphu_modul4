...
public class BlogService implements IBlogService {
    ...
    @Override
    public Page<Blog> findAlḷ(Pageable pageable) {
    ...
    @Override
    public Page<Blog> findAllByCategory_IdCategory(int id, Pageable pageable) {
        return this.iBlogRepository.findAllByCategory_IdCategory(id, pageable);
    }
